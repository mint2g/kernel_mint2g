...
EXPORT_SYMBOL(ist30xx_tsp_info);

TKEY_INFO ist30xx_tkey_info;
EXPORT_SYMBOL(ist30xx_tkey_info);
...
/* sysfs  */
static DEVICE_ATTR(mem, S_IRUGO | S_IWUSR | S_IWGRP, ist30xx_mem_show, ist30xx_mem_store);
static DEVICE_ATTR(refresh, S_IRUGO | S_IWUSR | S_IWGRP, ist30xx_frame_refresh, NULL);
static DEVICE_ATTR(filter, S_IRUGO | S_IWUSR | S_IWGRP, ist30xx_filter_show, NULL);
static DEVICE_ATTR(raw, S_IRUGO | S_IWUSR | S_IWGRP, ist30xx_raw_show, NULL);
...
static DEVICE_ATTR(debug, S_IRUGO | S_IWUSR | S_IWGRP, NULL, ist30xx_debug_store);
...
static DEVICE_ATTR(tunes_param, S_IRUGO | S_IWUSR | S_IWGRP, NULL, tunes_param_store);
